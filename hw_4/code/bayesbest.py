...
# Description:
#
#Features added to our Best Bayes classifier:
#Made classifier case insensitive, removed prior probability,
#added in 
...
class Bayes_Classifier:
   ...
   def __init__(self):
      ...
      if(not os.path.isfile("positivebest.pickle")) or (not os.path.isfile("negativebest.pickle")):
         self.positive = dict()
         self.negative = dict()
         self.train()
         self.calc_num_reviews()
         pickle.dump(self.positive, open("positivebest.pickle",'w'))
         pickle.dump(self.negative, open("negativebest.pickle",'w'))

      #IF both exist, load the pickled dictionaries
      else:
         self.positive = pickle.load(open("positivebest.pickle"))
         self.negative = pickle.load(open("negativebest.pickle"))
         self.calc_num_reviews()
